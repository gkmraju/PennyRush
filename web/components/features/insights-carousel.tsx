...
import { insights } from "@/lib/sample-data";
    ...
    <section aria-label="Insights">
      ...
      <div className="flex snap-x gap-4 overflow-x-auto pb-2">
        {insights.map((insight, index) => {
          const Icon = insight.severity === "warning" ? AlertTriangle : insight.severity === "success" ? CheckCircle2 : Info;
          return (
            <motion.article
              key={insight.title}
            ...
            >
              <div
                className={cn(
                  ...
                  insight.severity === "warning" && "bg-primary/20 text-primary",
